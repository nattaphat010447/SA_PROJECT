    ...
    <div class="flex-1 flex items-center justify-center">
      <div class="w-full max-w-sm flex flex-col items-center">
        ...
        <div class="w-full mb-6">
          <div class="relative">
            ...
            <input
              ...
              id="tags-search"
              type="text"
              class="w-full pl-11 pr-4 py-3.5 bg-gm-panel border border-transparent rounded-[12px] outline-none focus:border-gm-hover transition duration-200 text-white placeholder-gray-500 text-sm shadow-sm"
        ...
        <button
          @click="handleNext"
          id="tags-next-button"
          class="w-full py-3.5 bg-gm-primary text-white font-semibold rounded-[12px] shadow-[0_4px_20px_rgba(0,0,0,0.5)] hover:bg-gm-hover hover:text-black transition duration-200 cursor-pointer text-sm"
        >
          Next
        </button>
      </div>
